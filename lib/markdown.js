...
// "All" does...everything.
Markdown.dialects.all = Markdown.subclassDialect( Markdown.dialects.GFM );
Markdown.buildBlockOrder ( Markdown.dialects.all.block );
Markdown.buildInlinePatterns( Markdown.dialects.all.inline );

...
Markdown.prototype.split_blocks = function splitBlocks( input, startLine ) {
  ...
  if ( ( m = /^(\s*\n)/.exec(input) ) != null ) {
    ...
    line_no += helper.count_lines( m[0] );
...
Markdown.dialects.Gruber.inline["**"] = helper.strong_em("strong", "**");
Markdown.dialects.Gruber.inline["__"] = helper.strong_em("strong", "__");
Markdown.dialects.Gruber.inline["*"]  = helper.strong_em("em", "*");
Markdown.dialects.Gruber.inline["_"]  = helper.strong_em("em", "_");
